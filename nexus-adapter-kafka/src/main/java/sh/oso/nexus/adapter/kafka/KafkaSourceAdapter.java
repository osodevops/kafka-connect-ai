...
import sh.oso.nexus.adapter.kafka.config.KafkaSourceConfig;
...
public class KafkaSourceAdapter implements SourceAdapter {
    ...
    public ConfigDef configDef() {
        return new ConfigDef()
                .define(NexusConfig.KAFKA_SOURCE_BOOTSTRAP_SERVERS, ConfigDef.Type.STRING, ConfigDef.NO_DEFAULT_VALUE, ConfigDef.Importance.HIGH, "Source Kafka bootstrap servers")
                .define(NexusConfig.KAFKA_SOURCE_TOPICS, ConfigDef.Type.STRING, "", ConfigDef.Importance.HIGH, "Comma-separated source topics")
                .define(NexusConfig.KAFKA_SOURCE_TOPICS_REGEX, ConfigDef.Type.STRING, "", ConfigDef.Importance.HIGH, "Source topic regex pattern")
                .define(NexusConfig.KAFKA_SOURCE_GROUP_ID, ConfigDef.Type.STRING, "nexus-k2k-consumer", ConfigDef.Importance.MEDIUM, "Consumer group ID")
                .define(NexusConfig.KAFKA_SOURCE_POLL_TIMEOUT_MS, ConfigDef.Type.LONG, 1000L, ConfigDef.Importance.LOW, "Consumer poll timeout in ms")
                .define(NexusConfig.KAFKA_SOURCE_SECURITY_PROTOCOL, ConfigDef.Type.STRING, "PLAINTEXT", ConfigDef.Importance.MEDIUM, "Security protocol: PLAINTEXT, SSL, SASL_PLAINTEXT, SASL_SSL");
    }
