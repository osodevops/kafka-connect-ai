package sh.oso.nexus.adapter.kafka.config;
...
public class KafkaSourceConfig {
    ...
    public String bootstrapServers() {
        return props.getOrDefault(NexusConfig.KAFKA_SOURCE_BOOTSTRAP_SERVERS, "");
    }

    public List<String> topics() {
        String topics = props.getOrDefault(NexusConfig.KAFKA_SOURCE_TOPICS, "");
        if (topics.isEmpty()) {
            return List.of();
        }
    ...
    public String topicsRegex() {
        return props.getOrDefault(NexusConfig.KAFKA_SOURCE_TOPICS_REGEX, "");
    }

    public String groupId() {
        return props.getOrDefault(NexusConfig.KAFKA_SOURCE_GROUP_ID, "nexus-k2k-consumer");
    }

    public long pollTimeoutMs() {
        return Long.parseLong(props.getOrDefault(NexusConfig.KAFKA_SOURCE_POLL_TIMEOUT_MS, "1000"));
    }

    public String securityProtocol() {
        return props.getOrDefault(NexusConfig.KAFKA_SOURCE_SECURITY_PROTOCOL, "PLAINTEXT");
    }
