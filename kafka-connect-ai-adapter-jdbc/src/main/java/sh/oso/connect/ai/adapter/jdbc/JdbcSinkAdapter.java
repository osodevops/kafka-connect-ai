...
import sh.oso.connect.ai.adapter.jdbc.config.JdbcSinkConfig;
import sh.oso.connect.ai.adapter.jdbc.sql.InsertMode;
...
public class JdbcSinkAdapter implements SinkAdapter {
    ...
    public ConfigDef configDef() {
        return new ConfigDef()
                ...
                .define(AiConnectConfig.JDBC_TABLE, ConfigDef.Type.STRING, ConfigDef.NO_DEFAULT_VALUE, ConfigDef.Importance.HIGH, "Target table name")
                .define(AiConnectConfig.JDBC_SINK_PK_COLUMNS, ConfigDef.Type.STRING, "", ConfigDef.Importance.MEDIUM, "Comma-separated primary key columns")
                .define(AiConnectConfig.JDBC_SINK_INSERT_MODE, ConfigDef.Type.STRING, "insert", ConfigDef.Importance.MEDIUM, "Insert mode: insert, upsert, update")
                .define(AiConnectConfig.JDBC_SINK_AUTO_DDL, ConfigDef.Type.BOOLEAN, false, ConfigDef.Importance.LOW, "Auto-create table from record schema")
                .define(AiConnectConfig.JDBC_BATCH_SIZE, ConfigDef.Type.INT, 1000, ConfigDef.Importance.MEDIUM, "JDBC batch write size")
    ...
    public void start(Map<String, String> props) {
        ...
        hikariConfig.setPoolName("connect-ai-jdbc-sink");
