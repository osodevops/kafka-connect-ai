...
import sh.oso.connect.ai.adapter.jdbc.config.JdbcSourceConfig;
...
public class JdbcSourceAdapter implements SourceAdapter {
    ...
    public ConfigDef configDef() {
        return new ConfigDef()
                .define(AiConnectConfig.JDBC_URL, ConfigDef.Type.STRING, ConfigDef.NO_DEFAULT_VALUE, ConfigDef.Importance.HIGH, "JDBC connection URL")
                .define(AiConnectConfig.JDBC_USER, ConfigDef.Type.STRING, "", ConfigDef.Importance.HIGH, "JDBC username")
                .define(AiConnectConfig.JDBC_PASSWORD, ConfigDef.Type.PASSWORD, "", ConfigDef.Importance.HIGH, "JDBC password")
                .define(AiConnectConfig.JDBC_TABLE, ConfigDef.Type.STRING, ConfigDef.NO_DEFAULT_VALUE, ConfigDef.Importance.HIGH, "Source table name")
                .define(AiConnectConfig.JDBC_QUERY_MODE, ConfigDef.Type.STRING, "bulk", ConfigDef.Importance.MEDIUM, "Query mode: bulk, timestamp, incrementing, timestamp+incrementing")
                .define(AiConnectConfig.JDBC_TIMESTAMP_COLUMN, ConfigDef.Type.STRING, "updated_at", ConfigDef.Importance.MEDIUM, "Timestamp column name")
                .define(AiConnectConfig.JDBC_INCREMENTING_COLUMN, ConfigDef.Type.STRING, "id", ConfigDef.Importance.MEDIUM, "Incrementing column name")
                .define(AiConnectConfig.JDBC_POLL_INTERVAL_MS, ConfigDef.Type.LONG, 5000L, ConfigDef.Importance.MEDIUM, "Poll interval in ms")
                .define(AiConnectConfig.JDBC_DRIVER_CLASS, ConfigDef.Type.STRING, "", ConfigDef.Importance.MEDIUM, "JDBC driver class name")
                .define(AiConnectConfig.JDBC_QUERY, ConfigDef.Type.STRING, "", ConfigDef.Importance.MEDIUM, "Custom SQL query (overrides table)")
                .define(AiConnectConfig.JDBC_TABLES, ConfigDef.Type.STRING, "", ConfigDef.Importance.MEDIUM, "Comma-separated list of tables");
    }
    ...
    public void start(Map<String, String> props) {
        ...
        hikariConfig.setPoolName("connect-ai-jdbc-source");
