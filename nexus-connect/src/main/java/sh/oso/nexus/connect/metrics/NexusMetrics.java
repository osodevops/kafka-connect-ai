...
public class NexusMetrics {
    ...
    private static final String PREFIX = "nexus";

    private static volatile NexusMetrics instance;
    ...
    NexusMetrics(MeterRegistry registry) {
    ...
    public static NexusMetrics getInstance() {
        if (instance == null) {
            synchronized (NexusMetrics.class) {
                if (instance == null) {
                    ...
                    instance = new NexusMetrics(jmxRegistry);
                }
            }
        }
        return instance;
    ...
    // Visible for testing
    public static NexusMetrics createForTesting(MeterRegistry registry) {
        return new NexusMetrics(registry);
    }
