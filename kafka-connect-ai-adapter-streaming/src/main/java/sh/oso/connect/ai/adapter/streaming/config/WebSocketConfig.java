...
public class WebSocketConfig {
    ...
    public WebSocketConfig(Map<String, String> props) {
        this.props = props;
    }

    public String url() {
        return props.getOrDefault(AiConnectConfig.WEBSOCKET_URL, "");
    }

    public String subprotocol() {
        return props.getOrDefault(AiConnectConfig.WEBSOCKET_SUBPROTOCOL, "");
    }
