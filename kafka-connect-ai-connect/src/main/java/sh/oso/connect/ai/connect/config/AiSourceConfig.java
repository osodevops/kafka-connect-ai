...
public class AiSourceConfig extends AbstractConfig {

    public static final ConfigDef BASE_CONFIG = new ConfigDef()
            .define(
                    AiConnectConfig.SOURCE_ADAPTER,
                    ConfigDef.Type.STRING,
                    ConfigDef.NO_DEFAULT_VALUE,
                    ConfigDef.Importance.HIGH,
                    "Source adapter type (e.g., 'http')")
            .define(
                    AiConnectConfig.TOPIC,
                    ConfigDef.Type.STRING,
                    ConfigDef.NO_DEFAULT_VALUE,
                    ConfigDef.Importance.HIGH,
            ...
            .define(
                    AiConnectConfig.AGENT_SCHEMA_DISCOVERY,
                    ConfigDef.Type.BOOLEAN,
                    false,
                    ConfigDef.Importance.MEDIUM,
    ...
    public AiSourceConfig(Map<String, String> props) {
    ...
    public String sourceAdapterType() {
        return getString(AiConnectConfig.SOURCE_ADAPTER);
    }

    public String topic() {
        return getString(AiConnectConfig.TOPIC);
    }
